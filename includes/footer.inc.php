    ...
    <?php 
       ...
       }elseif(isset($_GET["url"]) && $_GET["url"] == "posts"){
           
            $data_type="single_post";
            
        }elseif(isset($_GET["url"]) && $_GET["url"] == "accounts/login"){
            
            $data_type="login";
            
        }elseif(isset($_GET["url"]) && $_GET["url"] == "accounts/signup"){
            
            $data_type="signup";

       }elseif(isset($_GET["url"]) && $_GET["url"] == "accounts/forgot_password"){

            $data_type="forgot_password";


       }elseif(isset($_GET["url"]) && $_GET["url"] == "accounts/reset_password"){
